...
{
	public class Skeleton_One : ModProjectile
	{
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D textureSkin = (Texture2D)ModContent.Request<Texture2D>("MrPlagueRaces/Content/Projectiles/Skeleton_One");
			...
			Main.EntitySpriteDraw(Skull_Texture[player.hair],
				Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY),
				sourceRectangleHead, new Color(player.skinColor.ToVector4() * lightColor.ToVector4() * Projectile.Opacity), -1.5753f, new Vector2(origin.X - 4, origin.Y + 22), Projectile.scale, SpriteEffects.FlipHorizontally, 0);
			Main.EntitySpriteDraw(Eyes_Texture[player.hair],
				Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY),
				sourceRectangleHead, new Color(player.eyeColor.ToVector4() * Projectile.Opacity * eyeGlow), -1.5753f, new Vector2(origin.X - 4, origin.Y + 22), Projectile.scale, SpriteEffects.FlipHorizontally, 0);
			return false;
		}
	}
}
