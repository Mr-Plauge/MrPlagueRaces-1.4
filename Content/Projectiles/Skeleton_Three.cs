...
{
	public class Skeleton_Three : ModProjectile
	{
		...
		public override void AI() {
			...
			if (skeletonPlayer.teleportThree) {
				...
				for (int i = 0; i < 3; i++) {
					Projectile.NewProjectile(Wiring.GetProjectileSource(0, 0), Projectile.Center.X + Main.rand.Next(60) - Main.rand.Next(60), Projectile.Center.Y + Main.rand.Next(60) - Main.rand.Next(60), 0f, 0f, ProjectileType<PuffDust>(), 0, 0, Projectile.owner);
				}
				Projectile.Kill();
			}
		...
		public override bool PreDraw(ref Color lightColor) {
			...
			Texture2D textureSkin = (Texture2D)ModContent.Request<Texture2D>("MrPlagueRaces/Content/Projectiles/Skeleton_Three");
			...
			Main.EntitySpriteDraw(Skull_Texture[player.hair],
				Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY),
				sourceRectangleHead, new Color(player.skinColor.ToVector4() * lightColor.ToVector4() * Projectile.Opacity), 0, new Vector2(origin.X - 14, origin.Y + 12), Projectile.scale, SpriteEffects.FlipHorizontally, 0);
			Main.EntitySpriteDraw(Eyes_Texture[player.hair],
				Projectile.Center - Main.screenPosition + new Vector2(0f, Projectile.gfxOffY),
				sourceRectangleHead, new Color(player.eyeColor.ToVector4() * Projectile.Opacity * eyeGlow), 0, new Vector2(origin.X - 14, origin.Y + 12), Projectile.scale, SpriteEffects.FlipHorizontally, 0);
			return false;
		}
	}
}
