...
namespace MrPlagueRaces.Content.Projectiles
{
	public class BouncyBoulder : ModProjectile
	{
		public override void SetStaticDefaults() {
			// DisplayName.SetDefault("BouncyBoulder");
		}
		...
		public override void PostDraw(Color lightColor) {
			...
			Texture2D glowmask = (Texture2D)ModContent.Request<Texture2D>("MrPlagueRaces/Content/Projectiles/BouncyBoulder_Glowmask");
