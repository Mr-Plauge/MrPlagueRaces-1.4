...
namespace MrPlagueRaces.Content.Projectiles
{
	public class Clustermine : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Clustermine");
		...
		public override void AI() {
			...
			if (koboldPlayer.triggeringMine > 0) {
				Explode();
			}
		...
		public override void PostDraw(Color lightColor) {
			Player player = Main.player[Projectile.owner];
			Texture2D textureEyes = (Texture2D)ModContent.Request<Texture2D>("MrPlagueRaces/Content/Projectiles/Clustermine_Eyes");
