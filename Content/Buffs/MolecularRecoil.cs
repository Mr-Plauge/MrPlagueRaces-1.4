	...
	public class MolecularRecoil: ModBuff
	{
		...
		public override void PostDraw(SpriteBatch spriteBatch, int buffIndex, BuffDrawParams drawParams) {
			...
			if (ownerPlayer != null) {
				...
				spriteBatch.Draw(textureHair, drawParams.Position, sourceRectangle, mrPlagueRacesPlayer.detailColor * Main.buffAlpha[buffIndex], 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			}
		}
	}
}
