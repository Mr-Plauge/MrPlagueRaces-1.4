	...
	public class LihzahrdRecipes : ModSystem
	{
		public override void AddRecipes() {
			Recipe.Create(ItemID.LihzahrdBrick, 10)
				...
				.AddCondition(Language.GetOrRegister("Mods.MrPlagueRaces.Conditions.LowHealth"), () => Main.LocalPlayer.GetModPlayer<MrPlagueRacesPlayer>().race is Lihzahrd && ModContent.GetInstance<MrPlagueRacesConfig>().raceStats)
				.Register();
