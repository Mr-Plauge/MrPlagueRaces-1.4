...
{
    internal class RaceDresserUI : UIState
    {
        ...
        private bool hasChangedClothStyle = false;
        ...
        public override void OnInitialize()
        {
            ...
            baseElement = new UIPanel()
            {
                ...
                Width = StyleDimension.FromPixelsAndPercent(465f, 0f),
                Height = StyleDimension.FromPixelsAndPercent(135f, 0f),
            ...
            baseElement.Append(playerColorSlider);
            ...
            UIPanel PlayerColorPanel = new UIPanel()
            {
                HAlign = 1f,
                VAlign = -2f,
                Width = StyleDimension.FromPixelsAndPercent(265f, 0f),
                Height = StyleDimension.FromPixelsAndPercent(135f, 0f),
                BackgroundColor = Color.Transparent,
                BorderColor = Color.Transparent
            };
            ...
            UIRaceButton uIClothStyleButton = new UIRaceButton(_player, 0, false, true)
            {
                HAlign = 0.08f,
                VAlign = 0f,
            };
            PlayerColorPanel.Append(uIClothStyleButton);

            _colorPickers = new UIRaceColoredImageButton[12];

            PlayerColorPanel.Append(CreateColorPicker(CategoryId.HairColor, "MrPlagueRaces/Assets/Textures/UI/ColorHair", 0.22f + 0.1f, 0f));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Eye, "MrPlagueRaces/Assets/Textures/UI/ColorEye", 0.44f + 0.1f, 0f));
            ...
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Skin, "MrPlagueRaces/Assets/Textures/UI/ColorSkin", 0.66f + 0.1f, 0f));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Detail, "MrPlagueRaces/Assets/Textures/UI/ColorDetailQuarter", 0.88f + 0.1f - 0.0905f, 0f, true));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.DetailAux1, "MrPlagueRaces/Assets/Textures/UI/ColorDetailQuarterOpposite", 0.88f + 0.1f, 0f, true, true));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.DetailAux2, "MrPlagueRaces/Assets/Textures/UI/ColorDetailQuarterBottom", 0.88f + 0.1f - 0.0905f, 0.247f, true, false, true));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.DetailAux3, "MrPlagueRaces/Assets/Textures/UI/ColorDetailQuarterBottomOpposite", 0.88f + 0.1f, 0.247f, true, true, true));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Shirt, "MrPlagueRaces/Assets/Textures/UI/ColorShirt", 0.22f + 0.1f, 0.7f));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Undershirt, "MrPlagueRaces/Assets/Textures/UI/ColorUndershirt", 0.44f + 0.1f, 0.7f));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Pants, "MrPlagueRaces/Assets/Textures/UI/ColorPants", 0.66f + 0.1f, 0.7f));
            PlayerColorPanel.Append(CreateColorPicker(CategoryId.Shoes, "MrPlagueRaces/Assets/Textures/UI/ColorShoes", 0.88f + 0.1f, 0.7f));

            confirmButton = new UITextPanel<string>("Change")
            {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!IsDresserNearby())
            {
                ModContent.GetInstance<UIRedirectionSystem>().HideDresserUI();
                UpdateColorPickers();
            }
        }
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            hasChangedClothStyle = _originalSkinVariant != Main.LocalPlayer.skinVariant;
            hasChangedAnyColor = _originalHairColor != Main.LocalPlayer.hairColor || _originalSkinColor != Main.LocalPlayer.skinColor || _originalDetailColor != mrPlagueRacesPlayer.detailColor || _originalAuxilaryDetailColor1 != mrPlagueRacesPlayer.auxilaryDetailColor1 || _originalAuxilaryDetailColor2 != mrPlagueRacesPlayer.auxilaryDetailColor2 || _originalAuxilaryDetailColor3 != mrPlagueRacesPlayer.auxilaryDetailColor3 || _originalEyeColor != Main.LocalPlayer.eyeColor || _originalShirtColor != Main.LocalPlayer.shirtColor || _originalUnderShirtColor != Main.LocalPlayer.underShirtColor || _originalPantsColor != Main.LocalPlayer.pantsColor || _originalShoeColor != Main.LocalPlayer.shoeColor;
            _player.Male = Main.LocalPlayer.Male;

            if (!(hasChangedClothStyle || hasChangedAnyColor))
            {
        ...
        private void UpdateColorPickers()
        {
            ...
            _colorPickers[8].SetColor(Main.LocalPlayer.shirtColor);
            _colorPickers[9].SetColor(Main.LocalPlayer.underShirtColor);
            _colorPickers[10].SetColor(Main.LocalPlayer.pantsColor);
            _colorPickers[11].SetColor(Main.LocalPlayer.shoeColor);
        ...
        {
            if (((UITextPanel<string>)evt.Target) == confirmButton && (hasChangedAnyColor || hasChangedClothStyle))
            {
                SoundEngine.PlaySound(SoundID.MenuTick);
        ...
        public bool IsDresserNearby()
        {
            bool dresserNearby = true;

            if (Main.npcChatText != "" || Main.npcShop != 0 || Main.LocalPlayer.talkNPC != -1)
            {
                dresserNearby = false;
            }
            if (!Main.LocalPlayer.IsInInteractionRangeToMultiTileHitbox(Main.interactedDresserTopLeftX, Main.interactedDresserTopLeftY) || !Main.tile[Main.interactedDresserTopLeftX, Main.interactedDresserTopLeftY].HasUnactuatedTile)
            {
                dresserNearby = false;
            }

            return dresserNearby;
        }
    }
}