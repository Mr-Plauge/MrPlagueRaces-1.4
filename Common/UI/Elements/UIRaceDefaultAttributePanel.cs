...
{
	public class UIRaceDefaultAttributePanel : UIElement
	{
        ...
        public UIRaceDefaultAttributePanel(ref UIText hoverText)
		{
			...
			statText = new UIText(UICreateRace.enableDefaultAttribute ? "Yes" : "No")
            {
				HAlign = 0f,
				VAlign = 0.5f,
				Width = StyleDimension.FromPixelsAndPercent(0f, 1f),
				Height = StyleDimension.FromPixelsAndPercent(0f, 1f),
				Left = StyleDimension.FromPixelsAndPercent(110f, 0f),
				Top = StyleDimension.FromPixelsAndPercent(6f, 0f),
				TextColor = Color.Gray
			};
			statBackground.Append(statText);
            titleText = new UIText("Example Attribute Modifier:")
            {
                HAlign = 0f,
                VAlign = 0.5f,
                Width = StyleDimension.FromPixelsAndPercent(0f, 1f),
		...
		public override void LeftMouseDown(UIMouseEvent evt)
        {
			...
			UICreateRace.enableDefaultAttribute = !UICreateRace.enableDefaultAttribute;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
            ...
            if (UICreateRace.enableDefaultAttribute)
			{
            ...
            statText.SetText(UICreateRace.enableDefaultAttribute ? "Yes" : "No");
        ...
        public override void MouseOver(UIMouseEvent evt)
        {
            ...
            _hoverText.SetText("Include an example attribute modifier (immunity to fall damage) in your race.cs file.");
