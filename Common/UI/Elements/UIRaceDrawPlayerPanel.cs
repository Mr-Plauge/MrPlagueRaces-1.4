...
{
	public class UIRaceDrawPlayerPanel : UIElement
	{
        ...
        public UIRaceDrawPlayerPanel(ref UIText hoverText)
		{
			...
			statText = new UIText(UICreateRace.drawPlayerOnIcon ? "Yes" : "No")
            {
				HAlign = 0f,
				VAlign = 0.5f,
				Width = StyleDimension.FromPixelsAndPercent(0f, 1f),
				Height = StyleDimension.FromPixelsAndPercent(0f, 1f),
				Left = StyleDimension.FromPixelsAndPercent(105f, 0f),
				Top = StyleDimension.FromPixelsAndPercent(6f, 0f),
				TextColor = Color.Gray
			};
			statBackground.Append(statText);
            titleText = new UIText("Draw Player On Mod Icon:")
            {
                HAlign = 0f,
                VAlign = 0.5f,
                Width = StyleDimension.FromPixelsAndPercent(0f, 1f),
		...
		public override void LeftMouseDown(UIMouseEvent evt)
        {
			...
			UICreateRace.drawPlayerOnIcon = !UICreateRace.drawPlayerOnIcon;
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
            ...
            if (UICreateRace.drawPlayerOnIcon)
			{
            ...
            statText.SetText(UICreateRace.drawPlayerOnIcon ? "Yes" : "No");
        ...
        public override void MouseOver(UIMouseEvent evt)
        {
            ...
            _hoverText.SetText("Determine whether a capture of your race is drawn on your mod icon.");
